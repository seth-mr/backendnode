...
const sendVerificationCode = async (email, nombre, codigo, minutosExpiracion) => {
    ...
    await transporter.sendMail({
        ...
        html: `<p>Hola ${nombre},</p><p>Tu codigo de verificacion es <strong>${codigo}</strong>.</p><p>Este codigo expira en ${minutosExpiracion} minutos.</p><p>Si no solicitaste esta cuenta, ignora este mensaje.</p>`
    })
}
